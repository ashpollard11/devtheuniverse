	...
	methods: {
		...
		onMouseMove: function onMouseMove(e) {
			...
			TweenMax.delayedCall(5, function () {
				if (_this2.currentPos.x === e.x && _this2.currentPos.y === e.y) {

					_this2.morphTl = new TimelineMax({ repeat: -1, yoyo: true, repeatDelay: 1.5, onComplete: function onComplete() {
							_this2.morphTl.clear();
						}, onRepeat: function onRepeat() {
							// this.morphFrames.push(this.morphFrames.shift());
							// this.morph_d_attr = this.morphFrames[0];
						} });

					_this2.morphTl.to("#curve1", 1.5, { morphSVG: "#morph_frame", ease: Back.easeOut }).to("#morph_frame", 1.5, { morphSVG: "#curve1", ease: Back.easeOut });
				} else {
					_this2.morphTl.clear();
				}
			});
